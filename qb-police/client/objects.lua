...
RegisterNetEvent('police:client:spawnObjects', function()
    Wait(100)
    exports['qb-menu']:openMenu({
        {
            header = "Police Objects",
...
RegisterNetEvent('police:client:removeObject', function(objectId)
    if not objectId then return end 
    if not ObjectList[objectId] then return end 
    if not ObjectList[objectId].object then return end 
    if DoesEntityExist(ObjectList[objectId].object) then 
